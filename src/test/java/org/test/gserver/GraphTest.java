...
public class GraphTest {
    ...
    @Test
    public void testRemoveAllAndUndo() throws GraphException {
        String graphId = UUID.randomUUID().toString();

        NodeKey k1 = new NodeKey("TYPE_P", new Pair<>("PID", "11111111111"));
        NodeKey k2 = new NodeKey("TYPE_P", new Pair<>("PID", "22222222222"));
        NodeKey k3 = new NodeKey("TYPE_P", new Pair<>("PID", "33333333333"));
        // create source node
        {
            Graph g = GFactory.get(graphId);
            g.beginTx();
        ...
        // add two node and relations
        {
            ...
            Map<String, String> edgeAttr1 = new HashMap<>();
            edgeAttr1.put("RELATION", "1");
            n1.addNeighbor(n2, edgeAttr1);
            Map<String, String> edgeAttr2 = new HashMap<>();
            edgeAttr2.put("RELATION", "2");
            n1.addNeighbor(n3, edgeAttr2);
            g.commitTx();
        }
        // delete all nodes consequently
        {
            Graph g = GFactory.get(graphId);
            g.removeNode(k1);
            g.removeNode(k2);
