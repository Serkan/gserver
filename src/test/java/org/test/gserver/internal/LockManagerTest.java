...
public class LockManagerTest {
    ...
    public void testAcquireLockTimeOut() throws GraphLockTimeOutException {
        ...
        LockManager lockManager = new LockManagerImpl(new GraphStorageLockSupport(graphId, new GraphActionFactoryMongo()));
        lockManager.lock(key);

        lockManager = new LockManagerImpl(new GraphStorageLockSupport(graphId, new GraphActionFactoryMongo()), new LockOwnerProvider() {
    ...
    public void testAcquireExpiredLock() throws GraphLockTimeOutException, InterruptedException {
        ...
        // try acquire lock
        {
            LockManager lockManager = new LockManagerImpl(new GraphStorageLockSupport(graphId, new GraphActionFactoryMongo()), new LockOwnerProvider() {
