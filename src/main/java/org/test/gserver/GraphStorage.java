...
public interface GraphStorage {
	...
	void changeTxFlagAs(boolean flag);

	boolean getTxFlag();

	int increaseCurrentVersion();

	int decreaseCurrentVersion();

	int getCurrentVersion();

	int getLastVersion();

	void changeLastVersionAs(int version);

	void removeElementsByVersion(int version);

	void inactivateElementsByVersion(int version);

	void activateElementsByVersion(int version);

	int nodesSize();

	void inactivateElementsByNode(NodeKey key);
